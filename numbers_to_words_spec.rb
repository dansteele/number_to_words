...
class NumberToWordsTest < MiniTest::Test
  describe "to_words" do
    ...
    #   123.to_words.must_equal("one-hundred and twenty-three")
    #   454.to_words.must_equal("four-hundred and fifty-four")
    #   832.to_words.must_equal("eight-hundred and thirty-two")
    # end
  end
end